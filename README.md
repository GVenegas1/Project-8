...
* fine_amount - how much the Patron owes the Library in late fines (measured in dollars); the fine is allowed to be negative (which would mean the Library owes the Patron money)
